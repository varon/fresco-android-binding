...
{
	public partial class LruBitmapPool {
		Java.Lang.Object Com.Facebook.Common.Memory.IPool.Get(int size) {
			return Android.Runtime.Extensions.JavaCast<Java.Lang.Object>(Get(size));
		}

		void IPool.Release(Object p0) {
			Release((Android.Graphics.Bitmap) p0);
		}
	...
	partial class MemoryPooledByteBufferFactory
	{
